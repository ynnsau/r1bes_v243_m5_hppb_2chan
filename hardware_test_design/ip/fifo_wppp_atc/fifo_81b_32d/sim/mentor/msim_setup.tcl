...
# ----------------------------------------
# If fifo_81b_32d is one of several IP cores in your
...
# ----------------------------------------
# ACDS 25.3 109 linux 2026.08.20.00:44:08
...
if ![info exists TOP_LEVEL_NAME] { 
  set TOP_LEVEL_NAME "fifo_81b_32d.fifo_81b_32d"
}
...
set LD_LIBRARY_PATH [dict merge $LD_LIBRARY_PATH [dict get [fifo_81b_32d::get_env_variables $SIMULATOR_TOOL_BITNESS] "LD_LIBRARY_PATH"]]
if {[dict size $LD_LIBRARY_PATH] !=0 } {
  set LD_LIBRARY_PATH [subst [join [dict keys $LD_LIBRARY_PATH] ":"]]
  setenv LD_LIBRARY_PATH "$LD_LIBRARY_PATH"
}
append ELAB_OPTIONS [subst [fifo_81b_32d::get_elab_options $SIMULATOR_TOOL_BITNESS]]
append SIM_OPTIONS [subst [fifo_81b_32d::get_sim_options $SIMULATOR_TOOL_BITNESS]]
...
alias file_copy {
  ...
  set memory_files [concat $memory_files [fifo_81b_32d::get_memory_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
  ...
  set normalized_src [fifo_81b_32d::normalize_path "$file"]
  set normalized_dest [fifo_81b_32d::normalize_path "$dest_file"]
...
set libraries [dict merge $libraries [fifo_81b_32d::get_dpi_libraries "$QSYS_SIMDIR"]]
...
set design_libraries [dict merge $design_libraries [fifo_81b_32d::get_design_libraries]]
...
alias com {
  ...
  set common_design_files [dict values [fifo_81b_32d::get_common_design_files "$QSYS_SIMDIR"]]
  
  set design_files [list]
  set design_files [concat $design_files [fifo_81b_32d::get_design_files "$QSYS_SIMDIR" "$QUARTUS_INSTALL_DIR"]]
