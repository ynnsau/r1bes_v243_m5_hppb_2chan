...
source "$script_dir/pll_0_intelclkctrl_200_3yp3h3q_parameters.tcl"
...
proc warn_skipped_instances { skipped_instances } {
        ...
        foreach clock_div_inst $skipped_instances {
                ...
                for {set outclk 0} {$outclk < $::GLOBAL_pll_0_intelclkctrl_200_3yp3h3q_out_clocks} {incr outclk} {
...
proc get_clock_divider_instances {} {
        ...
        set core $::GLOBAL_pll_0_intelclkctrl_200_3yp3h3q_core
...
foreach inst [get_clock_divider_instances] {
        ...
        set num_clock_fanins [ dict size $clock_fanins ]
        if { $num_clock_fanins < $::GLOBAL_pll_0_intelclkctrl_200_3yp3h3q_in_clocks } {
                warn_missing_clock_sources $clkdiv_inclk $::GLOBAL_pll_0_intelclkctrl_200_3yp3h3q_in_clocks clock_fanins other_fanins
        }        
