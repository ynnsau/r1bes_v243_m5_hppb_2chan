	fifo_36w_64d u0 (
		.data  (_connected_to_data_),  //   input,  width = 36,  fifo_input.datain
		...
		.q     (_connected_to_q_),     //  output,  width = 36, fifo_output.dataout
		.usedw (_connected_to_usedw_), //  output,   width = 6,            .usedw
